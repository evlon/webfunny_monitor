function f(p, p2) {
  ...
  f = function (p3, p4) {
    p3 = p3 - 0;
    let v = v_0x4f5b[p3];
    if (f.JpQPwc === undefined) {
      function f2(p5) {
        const v2 = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=";
        let v3 = "";
        let v4 = "";
        for (let v5 = 0, v6, v7, v8 = 0; v7 = p5.charAt(v8++); ~v7 && (v6 = v5 % 4 ? v6 * 64 + v7 : v7, v5++ % 4) ? v3 += String.fromCharCode(v6 >> (v5 * -2 & 6) & 255) : 0) {
          v7 = v2.indexOf(v7);
        }
...
undefined;
(function (p10, p11) {
  function f4(p12, p13, p14, p15, p16) {
    return f(p14 - -570, p16);
  }
  function f5(p17, p18, p19, p20, p21) {
    return f(p20 - 3, p21);
  }
  function f6(p22, p23, p24, p25, p26) {
    return f28(p24 - 843, p25);
  }
  function f7(p27, p28, p29, p30, p31) {
    return f(p28 - -332, p27);
  }
  function f8(p32, p33, p34, p35, p36) {
    return f(p36 - -638, p33);
  }
  function f9(p37, p38, p39, p40, p41) {
    return f28(p39 - 558, p40);
  }
  function f10(p42, p43, p44, p45, p46) {
    return f(p45 - 449, p44);
  }
  const vP10 = p10();
  function f11(p47, p48, p49, p50, p51) {
    return f28(p47 - -132, p49);
  }
  function f12(p52, p53, p54, p55, p56) {
    return f28(p52 - 304, p53);
  }
  do {
    try {
      const v15 = -parseInt(f10(2307, 6158, 2296, 4257, 5511)) / 1 * (parseInt(f9(395, 503, 1203, "*C2d", -275)) / 2) + -parseInt(f10(5335, 5434, 2696, 3225, 3624)) / 3 + -parseInt(f9(3603, 2314, 3552, "&5T0", 4752)) / 4 + parseInt(f8(2444, 1452, 1047, 1596, 1889)) / 5 * (-parseInt(f10(3254, 2068, -121, 1484, 2734)) / 6) + parseInt(f5(3343, 3912, 3267, 4372, 2499)) / 7 + -parseInt(f10(3575, 3196, 2578, 3438, 5399)) / 8 * (-parseInt(f6(4957, 1139, 2763, "v^iy", 559)) / 9) + parseInt(f12(2169, "j@]M", -142, 1010, 532)) / 10;
      if (v15 === p11) {
        break;
      } else {
        vP10.push(vP10.shift());
      }
    } catch (_0x1ce61f) {
      vP10.push(vP10.shift());
    }
...
(function () {
  function f13(p59, p60, p61, p62, p63) {
    return f28(p63 - 232, p62);
  }
  const v19 = {
    fxehG: f13(-13, -53, 1258, "NTIh", 479),
    dLmdx: function (p64, p65) {
      return p64(p65);
    }
  };
})();
